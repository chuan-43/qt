...
Map::Map(QWidget *parent) : QWidget(parent) {
    ...
    // 添加测试景点
    addSpot("蔚秀园","蔚秀园位于北京大学校园内，是校内著名的园林景观之一。"
    ...
    addSpot("校史馆","北大校史馆坐落于燕园核心区，是展示学校历史的殿堂。"
    ...
    addSpot("梅石碑","梅石碑立于北大未名湖畔，是校园著名文化景观之一。"
    ...
    addSpot("畅春园","畅春园位于北大西门外，是清代皇家园林杰出代表。"
    ...
    addSpot("华表","北大华表矗立于办公楼前，是校园标志性文物之一。"
    ...
    addSpot("未名湖","未名湖静卧燕园中央，是北大最负盛名的景观。"
    ...
    addSpot("图书馆","北大图书馆矗立校园中心，是知识的圣殿与象征。"
            "百年积淀藏书浩瀚，典籍文献逾千万册规模。"
            "李大钊曾任馆长，见证新文化运动重要历程。"
    ...
    addSpot("博雅塔","博雅塔巍然矗立未名湖畔，是北大标志性景观。"
            "原为水塔功能建筑，后成燕园文化精神象征。"
    ...
    addSpot("西门","北大西门庄严典雅，是燕园最具标志性的入口。"
    ...
    addSpot("革命烈士纪念馆","革命烈士纪念馆庄严肃穆，坐落于燕园之内。"
    ...
    addSpot("燕南园","燕南园坐落北大校园南部，是著名学者聚居区。"
    ...
    addSpot("三角地","三角地位于北大核心区，是校园重要交流空间。"
    ...
    addSpot("百年讲堂","百年讲堂矗立燕园中心，是北大文化地标建筑。"
            "红墙绿瓦气势恢宏，融合中西建筑艺术精华。"
    ...
    addSpot("北大餐饮服务区","北大餐饮服务区遍布校园，集中于此处。"
            "学一学五食堂菜式丰富，提供各地风味美食。"
            "农园餐厅环境现代，三层空间各具特色功能。"
            "便利超市24小时营业，随时满足生活所需。"
            "咖啡厅书香弥漫，是学术交流的理想场所。"
    ...
    addSpot("勺园","勺园坐落北大校园西北，是国际学术交流中心。"
            "园内建筑典雅别致，融合中西园林设计精华。"
            "主要接待来访学者，促进中外学术文化交流。"
            "客房设施完善舒适，营造温馨学术居住环境。"
            "会议中心设备先进，承办各类高端学术论坛。"
    ...
    addSpot("五四体育场","五四体育场位于北大东区，是校园运动核心场所。"
    ...
    addSpot("镜春园","镜春园静卧燕园东北，是北大古典园林瑰宝。"
            "园内湖面如镜倒映，春来垂柳拂水波光粼粼。"
            "原为清代淑春园部分，历经修葺保存完好。"
            "曲径通幽亭台错落，展现传统造园艺术精髓。"
            "朗润园遗址相邻，构成完整历史园林体系。"
...
void Map::addSpot(const QString &name, const QString &detail, const QPointF &scenePos) {
    auto *spot = new ClickableRectItem(name, detail);
...
void Map::showSearchResult(const QPointF &position) {
    // 显示绿色框
    searchResultMarker->setRect(position.x() - 10, position.y() - 10, 30, 30);
...
void Map::handleSpotClick(const QString &spotname,const QString &spotdetail){
    detail_or_review *dor=new detail_or_review(spotname ,spotdetail);
    dor->setAttribute(Qt::WA_DeleteOnClose); // 关闭时自动删除
    dor->setWindowModality(Qt::ApplicationModal);
    QRect screenGeometry = QApplication::primaryScreen()->geometry();
    int x = (screenGeometry.width() - dor->width()) / 2;
    int y = (screenGeometry.height() - dor->height()) / 2;
    dor->move(x,y);
    dor->show();
}
